...
function getAuthorByName(authorName, authors) {
  // Your code goes here
  return authors.find(
    book => book.name.toLowerCase() === authorName.toLowerCase()
  );
}
...
function mostProlificAuthor(authors) {
  ...
  authors.forEach(author => {
    if (author.books.length > maxLength) {
      maxLength = author.books.length;
      prolific = author.name;
    }
  });
  return prolific;
}
